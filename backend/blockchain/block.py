...
class Block:
	...
	def to_json(self):
		"""
		Serialisr the block into a dictionary of its atrributes
		"""
	...
	def mine_block(last_block, data):
		"""
		Mine a block based on the given last_block and data, until a block hash is found that meets he leading 0's proof of work requirement.
		"""
	...
	# 		raise Exception('The proof of requirement was not met')
		...
		reconstrustecd_hash = crypto_hash(
			block.timestamp,
			block.last_hash,
			block.data,
			block.nonce,
		...
		if block.hash != reconstrustecd_hash:
